...
const APPLICATIONS = [
  { id: 'ap1', kind: 'Admission', applicantName: 'Nived Pillai', dob: '2016-08-12', gender: 'M', notes: 'Grade V · Sibling of IX-B student; documents verified.', date: '2026-03-28', status: 'Pending', guardian: { name: 'Priya Pillai', relation: 'mother', phone: '+91 98470 11223', email: 'parent.priya.pillai@edkonic.in' } },
  { id: 'ap2', kind: 'Admission', applicantName: 'Zoya Sheikh', dob: '2013-11-02', gender: 'F', notes: 'Grade VIII · Transfer from Delhi; awaiting mark sheets.', date: '2026-03-25', status: 'Pending', guardian: { name: 'Imran Sheikh', relation: 'father', phone: '+91 98470 33445', email: 'parent.imran.sheikh@edkonic.in' } },
